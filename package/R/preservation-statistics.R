...
#' 
#' @import biganalytics bigmemory


#' Calculate the meanAdj statistic of a module in a test network
#' 
#' To minimise calculation all edges not to be calculated as part of the mean 
#' should be marked NA. For example, gene coexpression adjacency matrices from 
#' WGCNA should have their diagonal replaced with NA. For sparse networks the 
#' user will need to determine where NA or 0 is most appropriate.
#' 
